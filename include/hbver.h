...
#define HB_VER_RELEASE  9        /* Release number */
#define HB_VER_STATUS   "hernad"    /* Build status (all lowercase) */
#define __HARBOUR__     0x030409 /* Three bytes: Major + Minor + Release. This is recommented for 3rd party .c and .prg level code. */
